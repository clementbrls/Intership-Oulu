...
x_bee = 512  # coordinate of the bee in mm
y_bee = 380
z_bee = 10
...
# print(delta1,delta2)
'''
# calculate the audio offset between the mics


def offset_theo(x_bee, y_bee, z_bee, mic):
    x_mic = mic.x
    y_mic = mic.y
    z_mic = mic.z
...
delta0 = offset_theo(x_bee, y_bee, z_bee, mic0)
delta1 = offset_theo(x_bee, y_bee, z_bee, mic1)
delta2 = offset_theo(x_bee, y_bee, z_bee, mic2)
delta3 = offset_theo(x_bee, y_bee, z_bee, mic3)
...
points1, points2, points3 = m.reduce(points1, points2, points3)
